...
public class LoginController {
  ...
  public ResponseEntity<Map> getNaverLoginUrl() {
    //@TODO
    Map<String, String> map = new HashMap<>();
    map.put("loginUrl", naverClient.redirectToNaverAuth());
    return ResponseEntity.ok(map);
  }
  ...
  public ResponseEntity<LoginResponseDTO> processKakaoLoginCallback(@RequestParam("code") String authorizationCode) {
    ...
    LoginResponseDTO loginResponseDTO = loginService.loginOrCreate(response.toUserRequest(), OauthType.KAKAO);
  ...
  public ResponseEntity<LoginResponseDTO> processNaverLoginCallback(@RequestParam("code") String authorizationCode, @RequestParam("state") String state) throws UnsupportedEncodingException {
    ...
    LoginResponseDTO loginResponseDTO = loginService.loginOrCreate(response.toUserRequest(), OauthType.NAVER);
